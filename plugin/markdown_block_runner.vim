...
if exists('g:loaded_markdown_block_runner_vim') | finish | endif
let g:loaded_markdown_block_runner_vim = 1
...
function! Get_block(delimiters = ['```', '```'], temp_file = $HOME . '/.vim/plugged/markdown_block_runner.vim/temp/block') abort
